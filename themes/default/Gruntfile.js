		...
		requirejs: {
			compile: {
				options: {
					...
					modules: [{"name":"pagetypes\/default"},{"name":"pagetypes\/homepage"},{"name":"pagetypes\/page"},{"name":"pagetypes\/reportspage"},{"name":"pagetypes\/workpage"}] // add modules here. e.g. : {name: 'pagetypes/pagename'}
				}
			}
		},
