		...
		requirejs: {
			compile: {
				options: {
					...
					modules: [{"name":"pagetypes\/contactpage"},{"name":"pagetypes\/page"},{"name":"pagetypes\/redirectorpage"},{"name":"pagetypes\/workpage"},{"name":"pagetypes\/homepage"},{"name":"pagetypes\/aboutpage"},{"name":"pagetypes\/teampage"},{"name":"pagetypes\/errorpage"},{"name":"pagetypes\/default"},{"name":"pagetypes\/reportspage"}] // add modules here. e.g. : {name: 'pagetypes/pagename'}
				}
			}
		},
