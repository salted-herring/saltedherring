...
if ( typeof define === 'function' && define.amd ) {
  // AMD
  define( [
      'components/eventie/eventie',
      'components/doc-ready/doc-ready',
      'components/eventEmitter/EventEmitter',
      'components/get-size/get-size',
      'components/matches-selector/matches-selector',
      'components/outlayer/item'
    ],
    outlayerDefinition );
} else {
  // browser global
